...
public class PicUploadController {
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response)
        ...
        // 文件新路径 c:\\tmp\\upload\\11111111.jpg
        ...
        String picUrl = StringUtils.replace(
                StringUtils.substringAfter(filePath, this.picUploadService.REPOSITORY_PATH), "\\", "/");
        fileUploadResult.setUrl(picUploadService.IMAGE_BASE_URL + picUrl);
