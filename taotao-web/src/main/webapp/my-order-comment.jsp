...
<script type="text/javascript" src="/js/jquery-1.2.6.min.js"></script>
   <script type="text/javascript">
    ...
    $(function(){
    	...
    	$('#comm').blur(function(){
    		$('#comm').text('商品是否给力？快分享你的购买心得吧~');
    	});
    	$("#commentBox").hide();
    	    $("#pbcomment").click(function(){
    	    	$("#commentBox").show();
    	    });
    	    
    	    $('.tips-list li:not(:last)').each(function(){
    	      $(this).click(function(){
    	    ...
    	    $("#selfdefine").click(function(){
    	    	$("#selfdefine").addClass('hide');
    	    	$("#postComm").addClass('show').removeClass('hide');
    	    });
    	    ...
    	    $inp.keypress(function (event) {
    	        ...
    	        if (key == 13) {
    	          ...
    	          $('.tips-list li:not(:last)').after('<li vid="132" id="insertAttr" class="select"> <s class="f-check"></s>'+newattr+'</li>');
    	          $('#selfdefine').removeClass('hide');
    	          $('.list-last').removeClass('hide');
    	          $('#postComm').removeClass('show').addClass('hide');
    	        }
    	    });
    ...
    $(function(){
    	...
    	$(".commstar a").click(function(){
    		var _as = $(".commstar a");
    		var _count = _as.length;
    		var index = $(this).attr("_val") ;//2
    		for(var i=1; i<=_count;i++){
    			if(i<=index){
    				_as.eq(i - 1).addClass("active");
    			}else{
    				_as.eq(i - 1).removeClass("active");
    			}
    		}
    	});
                         ...
                         <div class="mc">
                            <div class="tb-void tb-line">
                                ...
                                <table class="tb-void tb-line">
                                    ...
                                    <tr>
                                        <td>
                                            <ul class="pro-info" oid="31428391548316" pid="${item.id}">
                                                <li class="fore1">
                                                    <div class="p-info clearfix">
                                                        <div class="p-img fl">
                                                            <a target="_blank" href="http://www.taotao.com/item/${item.id}.html">
                                                                <img width="50" height="50" title="${item.title}" data-img="1" src="${item.image} }" class="err-product">
                                                            </a>
                                                        </div>
                                                        <div class="p-name fl">
                                                            <a target="_blank" href="http://www.taotao.com/item/${item.id}.html">${item.title}</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="fore2">
                                                    <span class="ftx03">${order.createtime}</span>
                                                </li>



                                                <li class="fore3 forem">
                                                        <a href="javascript:;"  id="pbcomment" voucherstatus="0" class="pj" alt="${item.id}" title="发评价拿京豆" catefirst="670" catesecond="716" catethird="720">发表评价<b class="icon-show"></b></a>
                                                </li>
                                            </ul>
                                            <div class="clr"></div>
                                           <div class="comment-box prompt01" oid="3122336930" pid="${item.id}" style="display: block;" id="commentBox">
                                                <div class="box-t"></div>
                                                <div class="form" tagflag="true" isconspros="0" pid="${item.id}">
                                                    ...
                                                    <div class="item tagEl" style="">
                                                        ...
                                                        <div class="fl">
                                                            ...
                                                            <c:forEach items="${tagList}" var="tag" >
                                                                <li vid="${tag.id}"><s class="f-check"></s>${tag.name}</li>
                                                            </c:forEach>
                                                                <li class="list-last">
                                                                    <div class="fore1" id="selfdefine"><s class="f-input"></s>自定义</div>
                                                                    <div class="fore2 hide" id="postComm">
                                                                        <input type="text" maxlength="12" class="itxt" id="newAttr">
                                                    ...
                                                    <div class="item item01 xindeEl">
                                                        ...
                                                        <div class="cont">
                                                            <textarea name="" cols="" rows="" class="area area01" id="comm">商品是否给力？快分享你的购买心得吧~</textarea>
                                                            <div class="clr"></div>
                                                    ...
                                                    <div class="item item02">
                                                        ...
                                                        <div class="fl">
                                                            <a href="/assess/add" class="btn btn-5 mr20">
                                                                <s></s>
