    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
            <div class="mod-main">
						<div class="mt">
							<ul class="extra-l">
								<li class="fore-1"><a href="http://www.taotao.com/service/page/my-info">基本信息</a></li>
                                <li class="fore-2"><a class="curr" href="http://www.taotao.com/service/page/my-info-img">头像照片</a></li>
