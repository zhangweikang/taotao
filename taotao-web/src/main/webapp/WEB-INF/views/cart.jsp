   ...
   <script type="text/javascript">
   	...
   	$(function(){
   		...
   		$("#toSettlement").click(function(){
   			//getIds();
   			 $("input[name='checkItem']").each(function(e){
		  			if(this.checked){
		  			var id = this.value;
		  			array.push(id);
		  			}
   			...
   			if(array.size == 0){
   				alert("必须选择一个商品才能提交订单");
   				return;
   			}
   			var ids = array.join(':');
   			window.open("http://www.taotao.com/order/create.html?ids="+ids);
   		});
   		//页面删除选中商品的方法
   		...
   		//getIds();
  			...
  			var ids = array.join(':');
  			window.open("http://www.taotao.com/cart/deleteChecked.html?ids="+ids);
   		});
   	});
   function getIds(){
	   $("input[name='checkItem']").each(function(e){
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        <div class="column t-checkbox form"><input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox" value=""><label for="toggle-checkboxes_up">全选</label></div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            <div class="cell p-checkbox"><input data-bind="cbid:1" type="checkbox" name="checkItem" value="${cart.id }"></div>
		            <div class="cell p-goods">
		                ...
		                <div class="p-name">
		                	<a href="http://www.taotao.com/item/${cart.id }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.title}</a>
		            ...
		            <div class="cell p-inventory stock-11345721" id="kucun">有货</div>
          ...
          <div class="cart-toolbar clearfix">
            ...
            <div class="amout fr"><span id="selectedCount"></span><font color="red" size="5px">${totalNum }</font>件商品</div>
        </div>
