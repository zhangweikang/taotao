...
<body>
	...
	function validateCode(){
		var code= $("#code").val();
		var phone = ${user.phone};
		location.href="/user/validateCode.html?phone="+phone+"&code="+code;
		return false;
	}
                        ...
                        <div class="mc">
                            ...
                            <div class="form formno">
                                        ...
                                        <!-- <div class="item">
                                            ...
                                            <div class="fl">
                                                <strong class="ftx-un">jddodo51</strong>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="fl">
                                                <strong id="mobileSpan" class="ftx-un">${user.phone}</strong>
                                                <div class="clr"></div>
                                                <!-- <div class="msg-text">若该手机号无法接收验证短信，请拨打客服电话400-606-5500转7申诉更改验证手机</div> -->
                                            </div>
                                            <div class="clr"></div>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="fl">
                                                <input class="itxt" name="code" tabindex="1" id="code"   type="text">
                                                <!-- <a href="javascript:sendFindPwdCode('0d806ff2fb89b8232bdf1d53f80f6e7f');" id="sendMobileCode" class="btn btn-10 ml10"><s></s>获取短信校验码</a> -->
                                                <!-- 跳转修改密码 -->
                                                <a onclick="sendCode()"  id="sendMobileCode" class="btn btn-10 ml10"><s></s>获取短信校验码</a>
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="fl">
                                                <a href="javascript:void(0);" tabindex="8" id="submitCode" disabled="disabled" onclick="validateCode()" class="btn-5">提交</a>
                                            </div>
                                            <div class="clr"></div>
                                        </div>
                                    </div>
