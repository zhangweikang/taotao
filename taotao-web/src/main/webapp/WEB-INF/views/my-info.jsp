    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
			...
			<div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                <li class="fore-1"><a class="curr" href="http://www.taotao.com/service/user/userinfo/query">基本信息</a></li>
                                <li class="fore-2"><a href="http://www.taotao.com/service/page/my-info-img">头像照片</a></li>
                                <li class="fore-3"><a href="http://www.taotao.com/service/page/my-info-more">更多个人信息</a></li>
                            ...
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" id="nickName" name="nickName" value="${userVo.nickName}">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" name="realName" id="realName" value="${userVo.realName }">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            ...
                                            <select name="city" class="selt mr5" id="city" value="2826"><option value="2809" >黄浦区</option><option value="2811">卢湾区</option><option value="2813">徐汇区</option><option value="2815">长宁区</option><option value="2817">静安区</option><option value="2820">闸北区</option><option value="2822">虹口区</option><option value="2823">杨浦区</option><option value="2824">宝山区</option><option value="2825">闵行区</option><option value="2826">嘉定区</option><option value="2830">浦东新区</option><option value="2833">青浦区</option><option value="2834">松江区</option><option value="2835">金山区</option><option value="2836">南汇区</option><option value="2837">奉贤区</option><option value="2841">普陀区</option><option value="2919">崇明县</option></select>
                                            <select name="county" class="selt mr5" id="county" value="2864"><option value="2864">内环</option><option value="2864">中环之间</option><option value="2864">外环以外</option></select>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt itxt1" name="address" id="address" value="${userVo.address}">
...
<script type="text/javascript">
	$(function(){
		...
		var birthday="${userVo.birthday}";
		var arr = birthday.split("-");
		/* for(var i=0;i<arr.length;i++)
		{
			$("#birthdayYear").val(arr[0]).addClass("selected");
			$("#birthdayMonth").val(arr[1]).addClass("selected");
			$("#birthdayDay").val(arr[2]).addClass("selected"); 
		} */
		
		
		var province = "${userVo.province}";
		$("select[name=province]").children().each(function() {
		...
		var city = "${userVo.city}";
		$("select[name=city]").children().each(function() {
		...
		var county = "${userVo.county}";
		$("select[name=county]").children().each(function() {
	 		if($(this).val()==county){
				$(this).addClass("selected");
			}
 		});
