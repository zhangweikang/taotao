...
<!-- <link type="text/css" rel="stylesheet"
	href="./password_files/saved_resource">
	<link type="text/css" rel="stylesheet"
		href="./password_files/myjd.safe.css" source="combo">
		<link type="text/css" rel="stylesheet"
			href="./password_files/saved_resource(1)" source="widget">
			<script type="text/javascript"
				src="./password_files/saved_resource(2)"></script>
			<script type="text/javascript"
				src="./password_files/saved_resource(3)"></script>
			<script type="text/javascript"
				src="./password_files/saved_resource(4)" source="widget"></script>
			<script type="text/javascript" src="./password_files/BigInt.js"></script>
			<script type="text/javascript" src="./password_files/RSA.js"></script>
			<script type="text/javascript" src="./password_files/Barrett.js"></script> -->
...
function check() {
	phone = $("#phone").val();
    location.href = "/user/confirmInfo.html?phone="+phone;
    return false
}
</script>
								...
								<div class="form formno">
									<div class="item">
										...
										<div class="fl">
											<input type="text" class="itxt" tabindex="1"
												id="phone" name="phone" value="已验证手机">
												<div class="clr"></div> <label id="username_error" calss=""></label>
									...
									<div class="item">
										<span class="label">&nbsp;</span>
										 ...
										 <div class="item">
                    						<input type="button" class="btn-img btn-regist" id="passwordSubmit" value="提交" 
                    						tabindex="8" onclick="check();"/>
                						</div>
	...
	<script type="text/javascript">
		try {
			document.execCommon("BackgroundImageCache", false, true)
		} catch (e) {
		}
	</script>
	...
	<script type="text/javascript" charset="utf-8"
		src="/misc/js/validate/validate_findPwd.js?t=20121101"></script>
	<div id="service-2014">
		<div class="w">
			<dl class="fore1">
				<dt>购物指南</dt>
		...
		<div id="footer-2014">
			...
			<div class="copyright">
				北京市公安局朝阳分局备案编号110105014669&nbsp;&nbsp;|&nbsp;&nbsp;京ICP证070359号&nbsp;&nbsp;|&nbsp;&nbsp;<a
					target="_blank"
					href="http://img14.360buyimg.com/da/jfs/t256/349/769670066/270505/3b03e0bb/53f16c24N7c04d9e9.jpg">互联网药品信息服务资格证编号(京)-经营性-2014-0008</a>&nbsp;&nbsp;|&nbsp;&nbsp;新出发京零&nbsp;字第大120007号<br><a
					rel="nofollow"
					href="http://misc.360buyimg.com/skin/df/i/com/f_music.jpg"
					target="_blank">音像制品经营许可证苏宿批005号</a>&nbsp;&nbsp;|&nbsp;&nbsp;出版物经营许可证编号新出发(苏)批字第N-012号&nbsp;&nbsp;|&nbsp;&nbsp;互联网出版许可证编号新出网证(京)字150号<br><a
						href="http://misc.360buyimg.com/wz/wlwhjyxkz.jpg" target="_blank">网络文化经营许可证京网文[2014]2148-348号</a>&nbsp;&nbsp;违法和不良信息举报电话：4006561155&nbsp;&nbsp;Copyright&nbsp;&copy;&nbsp;2004-2015&nbsp;&nbsp;京东JD.com&nbsp;版权所有<br>京东旗下网站：<a
