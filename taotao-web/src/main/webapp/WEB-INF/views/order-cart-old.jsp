		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://www.taotao.com/item/${cart.id}.html" target='_blank'><img width="52" height="52" src="${cart.image}"></a></div>
							 <div class="p-detail">
								<div class="p-name">
								...
								<div class="p-more">商品编号：${cart.id}<br />
																	<!-- icon图标预留-->
								<span id="promise_1057746" class="promise411"></span>
					  				  ...
					  				  <td class="p-price"><strong>￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${cart.price / 1000 }"/></strong>
					  </td>
					  				  <td class="p-promotion"> </td>
