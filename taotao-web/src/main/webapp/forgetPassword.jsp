                        ...
                        <div class="mc">
                            ...
                            <div class="form formno">
                                <div class="item">
                                    ...
                                    <div class="fl">
                                        <input type="text" class="itxt" tabindex="1" onfocus="usernameOnfocus();" onblur="usernameOnblur();" id="username" name="username" value="用户名/邮箱/已验证手机">
                                        <div class="clr"></div>
                                ...
                                <div class="item">
                                    ...
                                    <div class="fl">
                                        <a href="javascript:void(0);" class="btn-5" onclick="doIndex('a78662bd-ff48-4f54-aaa2-e21792d47661');" id="findPwdSubmit">提交</a>
                                    </div>
                                    <div class="clr"></div>
                                </div>
                            </div>
...
<script type="text/javascript" charset="utf-8" src="/misc/js/validate/validate_findPwd.js?t=20121101"></script>
