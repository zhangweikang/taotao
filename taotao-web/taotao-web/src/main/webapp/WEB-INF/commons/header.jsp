		...
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					...
					<c:forEach items="${navigation }" var="nv" varStatus="index">
					<li class="fore1" id="${index.index }" clstag="homepage|keycount|home2013|07a"><a href="http://www.taotao.com/">${nv.title }</a></li>
